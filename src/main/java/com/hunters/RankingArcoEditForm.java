...
public class RankingArcoEditForm extends EditForm{
	...
	public RankingArcoEditForm(AbstractBean<?> bean, int userCase) {
		super(bean, userCase);
		adicionarCampos();
	}
	...
	public boolean afterPersistOrSave(AjaxRequestTarget target) {
		JogadorRankingArcoBean jogAux = (JogadorRankingArcoBean) getForm().getModelObject();
