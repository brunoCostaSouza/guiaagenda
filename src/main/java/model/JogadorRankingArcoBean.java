...
import com.hunters.ListaRankingArco;

@Bean(nome="rankingarcoflecha")
public class JogadorRankingArcoBean extends AbstractBean<Integer> implements Serializable{
	...
	public String getNomeTitulo() {
		return "Jogador no Ranking de Arco e Flecha";
	}
