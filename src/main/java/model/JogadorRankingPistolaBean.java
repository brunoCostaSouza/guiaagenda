...
import com.hunters.ListaRankingPistola;

@Bean(nome="rankingpistola")
public class JogadorRankingPistolaBean extends AbstractBean<Integer> implements Serializable{
	...
	public Class<?> getClassList() {
		return ListaRankingPistola.class;
	}
	...
	public String getNomeTitulo() {
		return "Jogador no Ranking de Pistola";
	}
